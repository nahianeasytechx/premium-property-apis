...
// Helper function for reviews (if needed in future)
function processReviewData($review, $base_url) {
    // Add any future processing for reviews here
...
//////////////////////////////////////////////////////////////////////////////////////
//////////////////////////// Handle the 'get-all-reviews' action ////////////////////
//////////////////////////////////////////////////////////////////////////////////////
if ($action == 'get-all-reviews') {

    $allReviews = $data['review'] ?? [];
    
    // Process each review if needed (for future image handling)
    foreach ($allReviews as $key => $review) {
        $allReviews[$key] = processReviewData($review, $base_url);
    }
...
//////////////////////////////////////////////////////////////////////////////////////
//////////////////////// Handle 'get-review-by-id' action ////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////
if ($action == 'get-review-by-id') {
    $id = intval($_GET['id'] ?? 0);
    if (!$id) {
        echo json_encode([
            "success" => false,
    ...
    foreach ($data['review'] as $review) {
        if ($review['id'] == $id) {
            $found = processReviewData($review, $base_url);
            break;
        }
    }
